...
const Login = () => {
    ...
    //handle refs on username and password
    useEffect(() => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            } else if (err.status === 400) { //means bad request
                setErrMsg('Missing Username or Password')
            } else if (err.status === 401) { //unauthorized
                setErrMsg('Unauthorized')
            } else {
                setErrMsg(err.data?.message) //optional chaining syntax
            }
        ...
        <section className="public">
            ...
            <main className="login">
                ...
                <div className='centered_container'>
                    <form className="form max-width-400" onSubmit={handleSubmit}>
